...
public class ApiUtil {
    public static final String ENV_ROOT_URI = "CONDUCTOR_SERVER_URL";
    private static final String ENV_KEY_ID = "KEY_ID";
    private static final String ENV_SECRET = "KEY_SECRET";

    public static OrkesClients getOrkesClient() {
        final ApiClient apiClient = getApiClientWithCredentials();
        apiClient.setWriteTimeout(40_000);
        apiClient.setReadTimeout(40_000);
        apiClient.setConnectTimeout(40_000);
